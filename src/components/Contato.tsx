    ...
    <section id="contato" className="py-16 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* WhatsApp Card */}
          <Card className="p-8 bg-gradient-to-br from-green-50 to-green-100 border-green-200 text-center shadow-medium">
            <div className="mb-6">
          ...
          {/* Instagram Card */}
          <Card className="p-8 bg-gradient-to-br from-pink-50 to-purple-100 border-pink-200 text-center shadow-medium">
            <div className="mb-6">
