...
const Hero = () => {
  ...
  return (
    <section id="hero" className="pt-20 bg-gradient-hero text-white relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-10 left-10 w-20 h-20 border-2 border-white/20 rounded-full"></div>
        <div className="absolute bottom-20 right-20 w-32 h-32 border-2 border-white/20 rounded-full"></div>
      ...
      <div className="container mx-auto px-4 py-16 lg:py-24 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Contact Info */}
            <div className="flex flex-col sm:flex-row gap-6 mt-8 text-white/80">
          ...
          <div className="relative">
            <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-8 shadow-strong">
              <div className="text-center">
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-white/70">Atendimento</div>
                  </div>
                </div>
              </div>
            </div>
